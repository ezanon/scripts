...
$importartudo = false; // se true, ignora array unidadesCatraca e importa todos uspianos
$downloadtodasasfotos = true; // se true, faz download de todas as fotos novamente, senão apenas das que não tem
